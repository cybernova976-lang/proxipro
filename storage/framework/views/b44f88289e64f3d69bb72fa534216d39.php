...
<?php $__env->startSection('title', 'Tableau de bord - ProxiPro'); ?>
...
<div class="dash-wrap">
    ...
    <div class="dash-greeting">
        <div>
            <h1>Bonjour, <span><?php echo e(Auth::user()->name); ?></span></h1>
    ...
    <div class="top-row">
        <div class="mini-stat">
            ...
            <div>
                <div class="mini-stat-val"><?php echo e($ads->count()); ?></div>
        ...
        <div class="mini-stat">
            ...
            <div>
                <div class="mini-stat-val"><?php echo e($ads->where('status', 'active')->count()); ?></div>
        ...
        <div class="mini-stat">
            ...
            <div>
                <div class="mini-stat-val"><?php echo e($ads->sum('views') ?? 0); ?></div>
        ...
        <div class="mini-stat">
            ...
            <div>
                <div class="mini-stat-val"><?php echo e(Auth::user()->unreadMessagesCount() ?? 0); ?></div>
    ...
    <div class="actions-row">
        ...
        <a href="<?php echo e(route('verification.index')); ?>" class="action-card">
            ...
            <div>
                <h5>Vérification</h5>
                <p>
                    <?php if(Auth::user()->identity_verified): ?>
                        Identité vérifiée ✓
                    <?php else: ?>
        ...
        <a href="<?php echo e(route('contact.index')); ?>" class="action-card">
    ...
    <?php if((isset($activeBoostedAds) && $activeBoostedAds->count() > 0) || (isset($activeUrgentAds) && $activeUrgentAds->count() > 0) || (isset($proSubscription) && $proSubscription)): ?>
    <div class="table-section" style="margin-bottom: 24px;">
        ...
        <div class="active-subs-grid">
            ...
            <?php if(isset($proSubscription) && $proSubscription && $proSubscription['is_active']): ?>
            <?php
            ...
            ?>
            <div class="sub-card" style="border-left: 4px solid <?php echo e($planColor); ?>;">
                <div class="sub-card-header">
                    <div class="sub-card-icon" style="background: <?php echo e($planColor); ?>;">
                        <i class="fas fa-briefcase"></i>
                    </div>
                    <div>
                        <div class="sub-card-title">Abonnement <?php echo e($planLabel); ?></div>
                        <div class="sub-card-subtitle">
                            <?php if($subEnd): ?>
                                Expire le <?php echo e($subEnd->format('d/m/Y')); ?>
                    ...
                    <span class="sub-card-badge" style="background: <?php echo e($planColor); ?>20; color: <?php echo e($planColor); ?>;">Actif</span>
                </div>
                <?php if($subEnd): ?>
                <div class="sub-card-progress">
                    <div class="sub-progress-bar">
                        <div class="sub-progress-fill" style="width: <?php echo e($subProgress); ?>%; background: <?php echo e($planColor); ?>;"></div>
                    </div>
                    <div class="sub-progress-text">
                        <span><?php echo e($daysLeft); ?> jour<?php echo e($daysLeft > 1 ? 's' : ''); ?> restant<?php echo e($daysLeft > 1 ? 's' : ''); ?></span>
                        <span><?php echo e($subProgress); ?>% écoulé</span>
                    </div>
                </div>
                <?php endif; ?>
                <div class="sub-card-actions">
                    <a href="<?php echo e(route('pricing.index')); ?>" style="background: <?php echo e($planColor); ?>15; color: <?php echo e($planColor); ?>;">
            ...
            <?php if(isset($activeBoostedAds)): ?>
            <?php $__currentLoopData = $activeBoostedAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bAd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <div class="sub-card" style="border-left: 4px solid <?php echo e($bColor); ?>;">
                <div class="sub-card-header">
                    <div class="sub-card-icon" style="background: <?php echo e($bColor); ?>;">
                        <i class="fas fa-rocket"></i>
                    </div>
                    <div>
                        <div class="sub-card-title"><?php echo e($bLabel); ?> — <?php echo e(Str::limit($bAd->title, 25)); ?></div>
                        <div class="sub-card-subtitle">Expire le <?php echo e($bAd->boost_end->format('d/m/Y à H:i')); ?></div>
                    </div>
                    <span class="sub-card-badge" style="background: <?php echo e($bColor); ?>20; color: <?php echo e($bColor); ?>;">
                        <?php echo e($bDaysLeft); ?>j
                    </span>
                </div>
                <div class="sub-card-progress">
                    <div class="sub-progress-bar">
                        <div class="sub-progress-fill" style="width: <?php echo e($bProgress); ?>%; background: <?php echo e($bColor); ?>;"></div>
                    </div>
                    <div class="sub-progress-text">
                        <span><?php echo e($bDaysLeft); ?> jour<?php echo e($bDaysLeft > 1 ? 's' : ''); ?> restant<?php echo e($bDaysLeft > 1 ? 's' : ''); ?></span>
                        <span><?php echo e($bProgress); ?>% écoulé</span>
                    </div>
                </div>
                <div class="sub-card-actions">
                    <a href="<?php echo e(route('ads.show', $bAd)); ?>" style="background: <?php echo e($bColor); ?>15; color: <?php echo e($bColor); ?>;">
                        <i class="fas fa-eye"></i> Voir
                    </a>
                    <a href="<?php echo e(route('boost.show', $bAd)); ?>" style="background: <?php echo e($bColor); ?>15; color: <?php echo e($bColor); ?>;">
            ...
            <?php if(isset($activeUrgentAds)): ?>
            <?php $__currentLoopData = $activeUrgentAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uAd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="sub-card" style="border-left: 4px solid #dc2626;">
                <div class="sub-card-header">
                    ...
                    <div>
                        <div class="sub-card-title">URGENT — <?php echo e(Str::limit($uAd->title, 25)); ?></div>
                        <div class="sub-card-subtitle">
                            <?php if($uAd->urgent_until): ?>
                                Expire le <?php echo e($uAd->urgent_until->format('d/m/Y')); ?>
                    ...
                    <span class="sub-card-badge" style="background: #fef2f2; color: #dc2626;">
                        <?php if($uDaysLeft !== null): ?>
                            <?php echo e($uDaysLeft); ?>j
                        <?php else: ?>
                            Actif
                        <?php endif; ?>
                    </span>
                ...
                <div class="sub-card-progress">
                    <div class="sub-progress-bar">
                        <div class="sub-progress-fill" style="width: <?php echo e($uProgress); ?>%; background: #dc2626;"></div>
                    </div>
                    <div class="sub-progress-text">
                        <span><?php echo e($uDaysLeft); ?> jour<?php echo e($uDaysLeft > 1 ? 's' : ''); ?> restant<?php echo e($uDaysLeft > 1 ? 's' : ''); ?></span>
                        <span><?php echo e($uProgress); ?>% écoulé</span>
                    </div>
                </div>
                <?php endif; ?>
                <div class="sub-card-actions">
                    <a href="<?php echo e(route('ads.show', $uAd)); ?>" style="background: #fef2f220; color: #dc2626; border: 1px solid #fecaca;">
                        <i class="fas fa-eye"></i> Voir
                    </a>
                </div>
            </div>
    ...
    <div class="table-section">
        ...
        <div class="table-responsive">
            <table class="dash-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $ads->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <a href="<?php echo e(route('ads.show', $ad->id)); ?>" class="ad-title-link">
                                <?php echo e(Str::limit($ad->title, 40)); ?>

                            </a>
                        </td>
                        <td><span class="cat-badge"><?php echo e($ad->category); ?></span></td>
                        <td>
                            <span class="status-dot status-<?php echo e($ad->status == 'active' ? 'active' : ($ad->status == 'pending' ? 'pending' : 'expired')); ?>">
                                <?php echo e($ad->status == 'active' ? 'Active' : ($ad->status == 'pending' ? 'En attente' : 'Expirée')); ?>

                            </span>
                        </td>
                        <td style="color: #94a3b8;">
                            <i class="fas fa-eye me-1" style="font-size: 0.75rem;"></i><?php echo e($ad->views ?? 0); ?>

                        </td>
                        <td style="color: #94a3b8; font-size: 0.84rem;"><?php echo e($ad->created_at->format('d/m/Y')); ?></td>
                        <td style="text-align: center;">
                            <div class="d-flex justify-content-center gap-4">
                                <a href="<?php echo e(route('ads.show', $ad->id)); ?>" class="btn-table-action" title="Voir">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('ads.edit', $ad->id)); ?>" class="btn-table-action" title="Modifier">
                                    <i class="fas fa-pen"></i>
                                </a>
                                <form action="<?php echo e(route('ads.destroy', $ad->id)); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette annonce ?');">
                                    <?php echo csrf_field(); ?>
                                ...
                                <a href="<?php echo e(route('boost.show', $ad->id)); ?>" class="btn-table-action btn-table-boost" title="Booster">
                                    <i class="fas fa-rocket"></i>
                                </a>
                            </div>
                        </td>
    ...
    <div class="table-section" id="transactions-history" style="margin-top: 24px;">
        <div class="table-section-head">
            ...
            <a href="<?php echo e(route('home.export-transactions-pdf')); ?>" class="btn btn-sm" style="border-radius: 8px; font-size: 0.8rem; background: linear-gradient(135deg, #ef4444, #dc2626); color: white; display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px;">
                <i class="fas fa-file-pdf"></i>Exporter PDF
            </a>
        </div>

        <?php if($transactions->isEmpty() && $pointTransactions->isEmpty()): ?>
        <div class="empty-box">
        ...
        <div class="table-responsive">
            <table class="dash-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="color: #94a3b8; font-size: 0.84rem;"><?php echo e($tx->created_at->format('d/m/Y H:i')); ?></td>
                        <td>
                            <span class="tx-type-badge tx-type-<?php echo e(strtolower($tx->type ?? 'other')); ?>">
                                <?php if($tx->type === 'POINTS'): ?>
                                    <i class="fas fa-coins"></i> Achat de points
                                <?php elseif($tx->type === 'SUBSCRIPTION'): ?>
                                    <i class="fas fa-crown"></i> Abonnement
                                <?php elseif($tx->type === 'BOOST'): ?>
                                    <i class="fas fa-rocket"></i> Boost
                                <?php else: ?>
                                    <i class="fas fa-credit-card"></i> <?php echo e($tx->type ?? 'Paiement'); ?>

                                <?php endif; ?>
                            </span>
                        </td>
                        <td style="font-size: 0.88rem; color: #334155;"><?php echo e(Str::limit($tx->description ?? '-', 50)); ?></td>
                        <td>
                            <span class="tx-amount"><?php echo e(number_format($tx->amount, 0, ',', ' ')); ?> €</span>
                        </td>
                        <td>
                            <span class="status-dot status-<?php echo e($tx->status == 'completed' ? 'active' : ($tx->status == 'pending' ? 'pending' : 'expired')); ?>">
                                <?php echo e($tx->status == 'completed' ? 'Complété' : ($tx->status == 'pending' ? 'En attente' : ucfirst($tx->status ?? 'Inconnu'))); ?>

                            </span>
                        </td>
                        <td>
                            <?php if($tx->status === 'completed'): ?>
                                <a href="<?php echo e(route('purchase.invoice', ['type' => 'points', 'id' => $tx->id])); ?>" class="btn btn-sm btn-outline-secondary" style="font-size: 0.7rem; padding: 2px 8px; border-radius: 6px;" title="Télécharger la facture">
                    ...
                    <?php $__currentLoopData = $pointTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ptx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="color: #94a3b8; font-size: 0.84rem;"><?php echo e($ptx->created_at->format('d/m/Y H:i')); ?></td>
                        <td>
                            <span class="tx-type-badge tx-type-points">
                                <i class="fas fa-coins"></i> Points
                            </span>
                        </td>
                        <td style="font-size: 0.88rem; color: #334155;"><?php echo e(Str::limit($ptx->description ?? '-', 50)); ?></td>
                        <td>
                            <span class="tx-points <?php echo e($ptx->points >= 0 ? 'tx-points-positive' : 'tx-points-negative'); ?>">
                                <?php echo e($ptx->points >= 0 ? '+' : ''); ?><?php echo e($ptx->points); ?> pts
                            </span>
                        </td>
                        <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/home.blade.php ENDPATH**/ ?>