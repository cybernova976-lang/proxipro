...
<head>
    ...
    <title><?php echo e(config('app.name', 'ProxiPro')); ?> - La plateforme de services entre particuliers et professionnels</title>
    ...
    <nav class="nav-main sticky-top" id="mainNav">
        <div class="container">
            <div class="nav-inner">
                ...
                <ul class="nav-links">
                    <li><a href="<?php echo e(url('/ads')); ?>">Annonces</a></li>
                    <li><a href="<?php echo e(route('contact.index')); ?>">Contact</a></li>
                    <?php if(auth()->guard()->check()): ?>
                        <li><a href="<?php echo e(url('/home')); ?>" class="btn-nav-login">Tableau de bord</a></li>
                    <?php else: ?>
                        <li><a href="<?php echo e(route('login')); ?>" class="btn-nav-login"><i class="fas fa-sign-in-alt me-1"></i>Connexion</a></li>
                        <?php if(Route::has('register')): ?>
                            <li><a href="<?php echo e(route('register')); ?>" class="btn-nav-register"><i class="fas fa-user-plus me-1"></i>S'inscrire gratuitement</a></li>
                        <?php endif; ?>
                    <?php endif; ?>
                </ul>
            ...
            <div id="mobileMenu" class="collapse" style="padding-bottom: 16px;">
                <div class="d-flex flex-column gap-2">
                    <a href="<?php echo e(url('/ads')); ?>" class="d-block py-2 text-decoration-none text-dark fw-semibold">Annonces</a>
                    <a href="<?php echo e(route('contact.index')); ?>" class="d-block py-2 text-decoration-none text-dark fw-semibold">Contact</a>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="btn btn-primary btn-sm rounded-3 mt-2">Tableau de bord</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary btn-sm rounded-3 mt-2">Connexion</a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-sm rounded-3">S'inscrire</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="steps-grid">
                <div class="step-card reveal">
                    ...
                    <p>Recherchez parmi nos <?php echo e(count($categoriesWithSubs)); ?> catégories ou publiez directement votre demande avec tous les détails.</p>
                </div>
                <div class="step-card reveal">
            ...
            <div class="dual-cta">
                ...
                <div class="cta-card cta-pro reveal">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        ...
                        <a href="<?php echo e(route('contact.index')); ?>" class="btn-cta-outline">En savoir plus</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    <h5>Informations</h5>
                    <ul>
                        <li><a href="<?php echo e(url('/legal/terms')); ?>">Conditions d'utilisation</a></li>
                        <li><a href="<?php echo e(url('/legal/privacy')); ?>">Confidentialité</a></li>
                        <li><a href="<?php echo e(url('/legal/cookies')); ?>">Cookies</a></li>
                        <li><a href="<?php echo e(url('/legal/mentions')); ?>">Mentions légales</a></li>
                    </ul>
                </div>
                <div class="footer-col">
                    <h5>Contact</h5>
            ...
            <div class="footer-bottom">
                <span>&copy; <?php echo e(date('Y')); ?> ProxiPro. Tous droits réservés.</span>
...
<?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/pages/home.blade.php ENDPATH**/ ?>