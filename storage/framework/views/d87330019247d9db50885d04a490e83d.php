                ...
                <div class="provider-modal-title-wrapper">
                    ...
                    <div>
                        <h5 class="modal-title" id="becomeProviderModalLabel">
                            <?php if(Auth::user()->is_service_provider): ?>
                                Gérer mes services
                            <?php else: ?>
                                Devenir Prestataire
                            <?php endif; ?>
...
(function() {
    ...
    async function loadCategories() {
        ...
        try {
            const response = await fetch('<?php echo e(route("service-provider.categories")); ?>');
    ...
    async function loadExistingServices() {
        try {
            const response = await fetch('<?php echo e(route("service-provider.my-services")); ?>');
            const data = await response.json();
    ...
    async function submitProvider() {
        ...
        try {
            const response = await fetch('<?php echo e(route("service-provider.register")); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/partials/provider-modal.blade.php ENDPATH**/ ?>