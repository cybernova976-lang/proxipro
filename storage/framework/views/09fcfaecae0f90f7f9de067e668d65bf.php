...
<?php if(auth()->check() && auth()->user()->shouldShowCategorySelectionModal()): ?>
        ...
        <div class="onb-body">
            ...
            <div id="onb-step-3" style="display:none;">
                ...
                <div style="margin-bottom:14px;">
                    ...
                    <input type="text" class="onb-input" id="onb-address" placeholder="Ex: 12 rue de la Paix, 75001 Paris" value="<?php echo e(auth()->user()->address ?? ''); ?>">
                </div>

                <div class="onb-input-row">
                    <div>
                        <label class="onb-input-label">Ville</label>
                        <input type="text" class="onb-input" id="onb-city" placeholder="Paris" value="<?php echo e(auth()->user()->city ?? ''); ?>">
                    </div>
                    <div>
                        <label class="onb-input-label">Rayon d'intervention (km)</label>
                        <input type="number" class="onb-input" id="onb-radius" placeholder="30" min="1" max="200" value="<?php echo e(auth()->user()->pro_intervention_radius ?? 30); ?>">
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/partials/category-selection-modal.blade.php ENDPATH**/ ?>