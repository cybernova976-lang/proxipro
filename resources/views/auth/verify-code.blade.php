...
<div class="vc-page">
    <div class="vc-wrapper">
        ...
        <div class="vc-card">
            ...
            {{-- Spam folder notice --}}
            <div style="background:#fffbeb; border:1px solid #fde68a; border-radius:12px; padding:12px 16px; margin-bottom:20px; display:flex; align-items:flex-start; gap:10px;">
                <svg style="width:18px; height:18px; color:#d97706; flex-shrink:0; margin-top:2px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z"/>
                </svg>
                <p style="font-size:0.82rem; color:#92400e; line-height:1.5; margin:0;">
                    <strong>Vous ne trouvez pas l'e-mail ?</strong> Vérifiez votre dossier <strong>Courrier indésirable</strong> (spam). Si le message s'y trouve, marquez-le comme « Non spam ».
                </p>
            </div>
