...
@section('title', 'Paramètres - Prokejem')
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('settings.notifications') }}" method="POST">
                                ...
                                <div class="alert alert-light border mb-4 small text-muted">
                                    ...
                                    Les notifications dans l'espace personnel restent actives. Les notifications navigateur se règlent séparément sur chaque appareil.
                                </div>
