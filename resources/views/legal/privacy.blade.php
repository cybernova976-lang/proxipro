...
@section('title', 'Politique de confidentialité - ' . config('app.name', 'Prokejem'))
@section('meta_description', 'Comment ' . config('app.name', 'Prokejem') . ' collecte, utilise et protège vos données personnelles.')
