                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-modern mt-2" style="min-width: 240px;">
                                ...
                                <li class="d-lg-none"><a class="dropdown-item dropdown-item-modern" href="{{ route('lost-items.index') }}"><i class="fas fa-search-location" style="color: #f97316;"></i>Objets perdus</a></li>
