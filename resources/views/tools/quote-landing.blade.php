...
<head>
    ...
    <title>Créer un Devis ou une Facture Gratuit en Ligne | {{ config('app.name', 'Prokejem') }}</title>
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Créer un Devis ou une Facture Gratuit en Ligne | {{ config('app.name', 'Prokejem') }}">
    ...
    <script type="application/ld+json">
    {
        ...
        "name": "Prokejem - Générateur de Devis et Factures",
        "operatingSystem": "Web",
        ...
        "mainEntity": [
            {
                ...
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Inscrivez-vous gratuitement sur Prokejem, remplissez les informations de votre entreprise et de votre client, ajoutez vos lignes de produits ou services, et téléchargez votre devis en PDF en un clic. Votre premier devis est entièrement gratuit."
                }
            },
            {
                "@@type": "Question",
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Vous pouvez acheter des packs de crédits par carte bancaire (paiement sécurisé via Stripe) ou utiliser vos points Prokejem. Les crédits n'expirent jamais."
                }
            }
        ]
    }
...
<body class="font-sans bg-white text-gray-900 antialiased">
    ...
    <section class="py-20 bg-white" id="faq">
        <div class="max-w-3xl mx-auto px-4">
            ...
            <div class="space-y-4">
                @php
                    $faqs = [
                        ['q' => 'Comment creer un devis gratuit en ligne ?', 'a' => 'Inscrivez-vous gratuitement sur Prokejem, remplissez les informations de votre entreprise et de votre client, ajoutez vos lignes de produits ou services, et telechargez votre devis en PDF en un clic. Votre premier devis est entierement gratuit.'],
                        ...
                        ['q' => 'Comment payer pour des credits supplementaires ?', 'a' => 'Vous pouvez acheter des packs de credits par carte bancaire (paiement securise via Stripe) ou utiliser vos points Prokejem. Les credits n\'expirent jamais.'],
                    ];
                @endphp
    ...
    <footer class="bg-gray-900 text-gray-400 py-10">
        <div class="max-w-6xl mx-auto px-4 text-center">
            <p class="text-sm">&copy; {{ date('Y') }} {{ config('app.name', 'Prokejem') }}. Tous droits reserves.</p>
