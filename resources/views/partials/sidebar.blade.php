...
<aside class="sidebar-nav" id="sidebarNav">
    ...
    <nav class="sidebar-menu">
        <div class="menu-section">
            ...
            <a href="#" class="menu-item" data-dashboard-section="my-ads" onclick="dashboardNav('my-ads'); return false;">
                ...
                @endphp
                @if($myAdsCount > 0)
                    <span class="menu-badge">{{ $myAdsCount }}</span>
                @endif
            </a>
        ...
        <div class="menu-section">
            ...
            <a href="#" class="menu-item" data-dashboard-section="messages" onclick="dashboardNav('messages'); return false;">
                ...
                @endphp
                @if($unreadMessages > 0)
                    <span class="menu-badge urgent">{{ $unreadMessages > 99 ? '99+' : $unreadMessages }}</span>
                @endif
            </a>

            <a href="{{ route('contact.index') }}" class="menu-item {{ request()->routeIs('contact.*') ? 'active' : '' }}">
                <div class="menu-icon">
        ...
        <div class="menu-section">
            ...
            <a href="#" class="menu-item" data-dashboard-section="points" onclick="dashboardNav('points'); return false;">
                ...
                <span class="menu-badge points">{{ Auth::user()->available_points ?? 0 }}</span>
            </a>

            <a href="{{ route('pricing.index') }}" class="menu-item {{ request()->routeIs('pricing.*') ? 'active' : '' }}">
                <div class="menu-icon">
    ...
    <div class="sidebar-footer">
        <a href="{{ route('feed') }}" class="footer-link">
