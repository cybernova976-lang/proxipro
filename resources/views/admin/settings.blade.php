...
<div class="row mb-4">
    <div class="col">
        ...
        <p class="text-muted mb-0">Configuration générale de {{ $settings['general']['site_name'] ?? 'Prokejem' }}</p>
    </div>
</div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.settings.general') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="site_name" value="{{ $settings['general']['site_name'] ?? 'Prokejem' }}">
