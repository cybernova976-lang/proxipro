...
<head>
    ...
    <title>Service indisponible - ProxiPro</title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">L'application est en cours de maintenance ou de mise à jour. Veuillez réessayer dans quelques instants.</p>
