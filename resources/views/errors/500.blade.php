...
<head>
    ...
    <title>Erreur serveur - ProxiPro</title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">Oups ! Quelque chose s'est mal passé. Si le problème persiste, veuillez réessayer plus tard ou contacter le support.</p>
