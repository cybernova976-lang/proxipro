...
<div class="container py-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <div class="text-center p-3 bg-light rounded">
                                    <div class="mb-2"><i class="{{ $badge->icon }} fa-2x text-{{ $badge->color }}"></i></div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
            ...
            <a href="#" onclick="dashboardNav('transactions'); return false;" class="btn btn-sm btn-outline-primary">
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr><th>Date</th><th>Description</th><th>Type</th><th class="text-end">Points</th></tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        $typeColors = ['share' => 'primary', 'daily' => 'success', 'level_up' => 'warning', 'purchase' => 'info', 'subscription' => 'danger', 'welcome' => 'secondary'];
                                        $color = $typeColors[$transaction->type] ?? 'secondary';
                                    @endphp
                                    <span class="badge bg-{{ $color }}">{{ $transaction->type }}</span>
                                </td>
                                <td class="text-end">
