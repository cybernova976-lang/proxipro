            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-0">
                    <div class="list-group list-group-flush rounded">
                        <a href="#password" class="list-group-item list-group-item-action d-flex align-items-center py-3 active" data-bs-toggle="list">
                    ...
                    <div class="card border-0 shadow-sm border-danger">
                        ...
                        <div class="card-body p-4">
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-circle me-2"></i>
                                <strong>Attention !</strong> Cette action est <strong>irréversible</strong>. Toutes vos données seront supprimées.
                            </div>
                            
                            <form action="{{ route('settings.delete-account') }}" method="POST" 
                                  onsubmit="return confirm('Êtes-vous absolument sûr(e) ? Cette action est irréversible.')">
                                @csrf
                                
                                <div class="mb-3">
                                    <label for="settings_reason" class="form-label">Raison (optionnel)</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="settings_delete_password" name="password" required>
                                </div>
                                @endif
                                ...
                                <div class="form-check mb-4">
                                    ...
                                    <label class="form-check-label" for="settings_confirm_delete">
                                        Je comprends que cette action est <strong>définitive</strong>.
                                    </label>
                                </div>
